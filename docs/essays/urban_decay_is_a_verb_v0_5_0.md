...
See. Mass that persists can always be re-weighed, and never only on the original owner's scale. The building does not know it has been abandoned. The Goud street does not know the gold is gone. The copper is worth exactly what the copper is worth.
...
*Photographs and text: André S Clements. [Provenance and revision history.](https://github.com/AndreClements/README/blob/main/docs/essays/urban_decay_is_a_verb.md)*
