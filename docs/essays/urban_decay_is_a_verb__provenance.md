...
| # | Archive file | Place | Captured | Repo copy |
|---|---|---|---|---|
| 1 | `IMG_1278_urban_decay_is_a_verb` | Joe Slovo Drive, Johannesburg | 2023, **day unresolved** | `IMG_1278_urban_decay_is_a_verb.jpg` |
| 2 | `Life(ASClem_2015_07_29_1293)` | Johannesburg | 2015-07-29 21:33 · Wed | `Life_ASClem_2015_07_29_1293.jpg` |
| 3 | `04_crop_colour_3200` | Johannesburg CBD | 2017-03-19 02:22 · Sun | `04_crop_colour_3200.jpg` |
| 4 | `_MG_0800` | Highway outside the city | 2016-06-22 01:45 · Wed | `_MG_0800.jpg` |
| 5 | `MagNieGeboggelWordNie(StandertonElektries_2016)` | **Braamfontein** (see location note) | 2016-06-05 00:19 · Sun | `MagNieGeboggelWordNie_StandertonElektries_2016.jpg` |
| 6 | `DiepslootRefuseFire(ASClem_2015_10_08_1344_take2)` | Diepsloot | 2015-10-08 22:50 · Thu | `DiepslootRefuseFire_ASClem_2015_10_08_1344_take2.jpg` |
| 7 | `school_hillbrow` | Johannesburg (Hillbrow) | **undated, no EXIF** | `school_hillbrow.jpg` |
| 8 | `Zandspruit_Ballgame_2012_DSC6875` | Zandspruit | 2012-06-13 15:26 · Wed | `Zandspruit_Ballgame_2012_DSC6875.jpg` |
| 9 | `Durban Deep_2021(FNMBJ_Jul21_MG_0887)` | Durban Deep, West Rand | 2021-07-17 16:37 · Sat | `Durban_Deep_2021_FNMBJ_Jul21_MG_0887.jpg` |
| 10 | `FacesinBordeaux_2019_MG_6016e` | Bordeaux, France | 2019-04-26 22:30 · Fri | `FacesinBordeaux_2019_MG_6016e.jpg` |
| 11 | `OWN-tower(2014_07_30_1459_tmp)` | Johannesburg | 2014-07-30 22:54 · Wed | `OWN-tower_2014_07_30_1459_tmp.jpg` |
| 12 | `Midnight(Paris 2019)` | Paris | 2019-05-04 00:00:41 · Sat | `Midnight_Paris_2019.jpg` |
| 13 | `EventHorison(aPinhole-Poem)[…2017-2026]` | Bryanston / landfill (double exposure) | 2017–2026, composite | `EventHorison_aPinhole-Poem_2017-2026.jpg` |
...
- The flatbed's year is a correction: recollection said 2015, the file says 2016, which places it in that June's unrest rather than the previous year's. Bordeaux is France, not Randburg. The Bordeaux-to-Paris interval ("eight days earlier") is arithmetic on two stamps.
