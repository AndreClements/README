# Covering note to Aryan

*Draft. The operator's to send, alter, or discard — the register is his call, and he knows the
correspondence.*
...
Here is the piece for the decay issue.
...
— some of it is done, by somebody, for a few hundred rand, and the picture ought to say so. The
car window stays in the frame for the same reason.
