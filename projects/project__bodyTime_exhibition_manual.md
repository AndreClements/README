...
- **`Node`: The Contemporary Gallerist — *authorised, pending***  
  ...
  **Protocol:** Offer `bodyTime()` as evidence of ongoing, disciplined work.

- **`Node`: International Juried Exhibition (Opale Art, “Echoes of Lynch”) — *complete / attested***  
  **Intent:** Place the work in a new context; test its translatability.  
  **Protocol:** Respond to curated invitation with a refined packet: short biography, artist statement, and a critical text aligning the work with the theme.

### **4.3 The Facade Praxis: Dual Wall Texts**

Two texts hung side-by-side:

1) **Native:** the system’s home language for readers who want the full architecture.  
2) **Translated:** a warm, second-language English bridge for general audiences.

This visible “bilingual” move is part of the work: artifact first, then two honest ways in.
...
### **Opale Art — “Echoes of Lynch” (Jun–Jul 2025)**

- **Validation.** Following a direct invitation, the work was **jury-selected** for exhibition — a formal quorum attestation.  
- **Selection.** `20241101_1 (Toe)` chosen for display; strong alignment with themes of tension and fade.  
- **Translation.** The curatorial team distilled the artist texts into a French caption that kept the heart of the praxis.  
...
This event cleanly validates the P(a)/PPP stance: a high-integrity artifact generated a high-integrity external attestation.
...
- **Canonical Praxis:** `../../README.md`  
- **Core Methodology:** `../../docs/methods/METHODOLOGY_CI.md`  
- **Governing Protocols:** `../../docs/protocols/`  
- **Philosophical Ground:** `../../docs/models/`
