...
[32] **Carse, James P.**, _Finite and Infinite Games: A Vision of Life as Play and Possibility_ (1986). The `GameTypeDiagnostic.lib` — a clean binary (finite/infinite) that interrogates whether a system, relationship, or design choice is played to win or played to continue play. The parametric author is a more infinite player than not: constraints enable continuation, not determination. "Whoever must play, cannot play" grounds CARDS Autonomy as a precondition for play itself. **Bookend structure:** the book opens with "There are at least two kinds of games" and closes — as an entire final chapter of one sentence — with "There is but one infinite game." The binary is scaffolding the author himself dismantles. See also: Huizinga [_Homo Ludens_] (foundational play theory), SOLID [30] (OCP as infinite-game architecture), Pirsig [31] (shared genre: speculative-philosophical with heuristic utility), CARDS (Je'anna L Clements' "mode" reading of the final sentence).
...
[35] **Mollison, Bill & Holmgren, David**, *Permaculture: A Designers' Manual* (Mollison, 1988); *Permaculture: Principles and Pathways Beyond Sustainability* (Holmgren, 2002). The `DesignAsAttentionTopology.lib` — a design system grounded in an ethics triad (Earth Care, People Care, Fair Share) that operationalises axiological commitments as ecological and social practice. Twelve design principles (Holmgren) validated against peer-reviewed science (Krebs & Bach 2018). Zone planning as spatial grammar of proximity and interaction frequency; stacking functions as redundancy-through-diversity; edge effects as generative boundary design; succession as temporal trajectory. The permaculture designer is a parametric author: sets constraints (zone boundaries, guild compositions, edge ratios) within which the system generates its own yields. Permaculture's "permanent culture" expansion (from agriculture to settlement design) parallels this repo's substrate-independence — the principles transpose to studio practice, knowledge architecture, and organisational design with the same structural logic. See also: Wahl [33] (regenerative cultures as downstream application), Carse [32] (garden metaphor operationalised), Antonovsky [via SALUTOGENESIS.md] (salutogenic affordances empirically bridged by Stoltz & Schaffer 2018), Odum (systems ecology lineage), Fukuoka (philosophical lineage).

[34] **Walker Rettberg, Jill** (née Walker), "Feral Hypertext: When Hypertext Literature Escapes Control," *Proceedings of ACM Hypertext 2005* (Salzburg, 2005); *Electronic Literature* (Polity, 2018). The `FeralHypertext.lib` — a long-running influence (~30 years) that predates the paper formalising it. Pre-web hypertext was a domesticated species bred in captivity; on the web it went feral, no longer delimited by authorship or clear boundaries separating works. To work with it, think as hunter-gatherers, not farmers. Walker Rettberg's broader arc — from mid-1990s hypertext fiction criticism through pioneering academic blogging (jill/txt, 2000–) to the Centre for Digital Narrative (Bergen) — traces the passage from domesticated to feral across the medium's lifespan. This repo enacts the concept: a PowerShell script three posts from Matisse, poetry with changelogs, a GitHub repo as landart, a drawing-session CMS with a `ConsentGate` — no single author controls the boundaries of what it becomes. See also: Nelson [via research__computer_manual_history.md] (hypertext originator), Bateson [2] (pattern/ecology), de Certeau [4] (tactical emergence within strategic systems), Carse [32] (infinite game — played to continue play, not to win).